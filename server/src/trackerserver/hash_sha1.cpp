...
// 描述: SHA1散列
//-----------------------------------------------------------------------------
void HashSha1(const char *pData, int nDataSize, char chDigest[20])
{
    SHA1_CTX stContext;

    Sha1Init(&stContext);
    Sha1Update(&stContext, (unsigned char*)pData, nDataSize);
    Sha1Final((unsigned char*)chDigest, &stContext);
}
